  ...
  const retrieveRevHash = async function(inputPath, template) {
    ...
    if (revHash === undefined) {
      ...
      if (css === undefined) {
        ...
        css = await compile.call(this, inputContent, inputPath, sassOptions, template.config, postcss);
        if (css === undefined)
          css = null;
        compileCache.set(inputPath, css);
      }
    ...
    if (options.compileOptions?.permalink !== undefined) {
      ...
      eleventySassRevvedPermalink = async function(permalinkString, inputPath, template) {
        ...
        if (render !== false) {
          ...
          revHash = await retrieveRevHash.call(context, inputPath, template);
        }
      ...
      eleventySassRevvedPermalink = async function(permalinkString, inputPath, template) {
        ...
        let revHash = await retrieveRevHash.call(context, inputPath, template);
