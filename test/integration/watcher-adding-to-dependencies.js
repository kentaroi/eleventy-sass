...
test.before(async t => {
  ...
  let footerSCSS = path.join(dir, "stylesheets", "_footer.scss");
  fs.writeFile(footerSCSS, `footer {
...
test("watcher works", async t => {
  ...
  t.is(styleCSS, "header{background-color:pink}footer{background-color:blue}body{background-color:red}");
